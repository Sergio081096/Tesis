...
if("TRUE" STREQUAL "TRUE")
  set(handle_detector_SOURCE_PREFIX /home/sergio/Tesis/catkin_ws/src/vision/handle_detector)
  set(handle_detector_DEVEL_PREFIX /home/sergio/Tesis/catkin_ws/devel)
  ...
  set(handle_detector_INSTALL_PREFIX /home/sergio/Tesis/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handle_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sergio/Tesis/catkin_ws/src/vision/handle_detector/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT handle_detector_NUM_DUMMY_TARGETS)
      set(handle_detector_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::handle_detector::wrapped-linker-option${handle_detector_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR handle_detector_NUM_DUMMY_TARGETS "${handle_detector_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::handle_detector::wrapped-linker-option${handle_detector_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND handle_detector_LIBRARIES "${interface_target_name}")
...
set(handle_detector_EXPORTED_TARGETS "")
...
set(depends "geometry_msgs;pcl;pcl_conversions;pcl_ros;roscpp;sensor_msgs;std_msgs;tf;vision_msgs;point_cloud_manager")
