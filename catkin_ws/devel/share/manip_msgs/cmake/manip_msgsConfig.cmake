...
if("TRUE" STREQUAL "TRUE")
  set(manip_msgs_SOURCE_PREFIX /home/sergio/Tesis/catkin_ws/src/manipulation/manip_msgs)
  set(manip_msgs_DEVEL_PREFIX /home/sergio/Tesis/catkin_ws/devel)
  ...
  set(manip_msgs_INSTALL_PREFIX /home/sergio/Tesis/catkin_ws/install)
...
if(NOT "/home/sergio/Tesis/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manip_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sergio/Tesis/catkin_ws/src/manipulation/manip_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT manip_msgs_NUM_DUMMY_TARGETS)
      set(manip_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::manip_msgs::wrapped-linker-option${manip_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR manip_msgs_NUM_DUMMY_TARGETS "${manip_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::manip_msgs::wrapped-linker-option${manip_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND manip_msgs_LIBRARIES "${interface_target_name}")
