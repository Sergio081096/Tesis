...
(cl:defmethod cl:initialize-instance :after ((m <SphinxSetSearch>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SphinxSetSearch)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hri_msgs-msg:<SphinxSetSearch> is deprecated: use hri_msgs-msg:SphinxSetSearch instead.")))

(cl:ensure-generic-function 'search_id-val :lambda-list '(m))
(cl:defmethod search_id-val ((m <SphinxSetSearch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hri_msgs-msg:search_id-val is deprecated.  Use hri_msgs-msg:search_id instead.")
  (search_id m))

(cl:ensure-generic-function 'recognitionTime-val :lambda-list '(m))
(cl:defmethod recognitionTime-val ((m <SphinxSetSearch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hri_msgs-msg:recognitionTime-val is deprecated.  Use hri_msgs-msg:recognitionTime instead.")
  (recognitionTime m))
