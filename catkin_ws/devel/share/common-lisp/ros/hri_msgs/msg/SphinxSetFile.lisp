...
(cl:defmethod cl:initialize-instance :after ((m <SphinxSetFile>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SphinxSetFile)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hri_msgs-msg:<SphinxSetFile> is deprecated: use hri_msgs-msg:SphinxSetFile instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SphinxSetFile>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hri_msgs-msg:id-val is deprecated.  Use hri_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'file_path-val :lambda-list '(m))
(cl:defmethod file_path-val ((m <SphinxSetFile>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hri_msgs-msg:file_path-val is deprecated.  Use hri_msgs-msg:file_path instead.")
  (file_path m))
