...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<InverseKinematicsPath-response>)))
  ...
  (cl:format cl:nil "std_msgs/Float32MultiArray[] articular_path     ~%~%#Yes, the result is an array of arrays. Each Float32MultiArray is an array of seven floats~%#that represents the angles of each joint.~%#Articular_path is an array of n articular positions.~%#Float32MultiArray is used because left and right arm nodes are subscribed to topics of this type~%~%#Cartesian path is an array of Poses, and each pose represent a position in a 6DOF space,~%#neverthless, arm is 7DOF. The IK algorithm is supossed to calculate the best elbow position~%#for each Pose.~%~%#If goal pose is out of the workspace, a false should be returned when service is called.~%#Reachability of a given position can be determined by trying to calculate its inverse kinematics~%~%================================================================================~%MSG: std_msgs/Float32MultiArray~%# Please look at the MultiArrayLayout message definition for~%# documentation on all multiarrays.~%~%MultiArrayLayout  layout        # specification of data layout~%float32[]         data          # array of data~%~%~%================================================================================~%MSG: std_msgs/MultiArrayLayout~%# The multiarray declares a generic multi-dimensional array of a~%# particular data type.  Dimensions are ordered from outer most~%# to inner most.~%~%MultiArrayDimension[] dim # Array of dimension properties~%uint32 data_offset        # padding elements at front of data~%~%# Accessors should ALWAYS be written in terms of dimension stride~%# and specified outer-most dimension first.~%# ~%# multiarray(i,j,k) = data[data_offset + dim_stride[1]*i + dim_stride[2]*j + k]~%#~%# A standard, 3-channel 640x480 image with interleaved color channels~%# would be specified as:~%#~%# dim[0].label  = \"height\"~%# dim[0].size   = 480~%# dim[0].stride = 3*640*480 = 921600  (note dim[0] stride is just size of image)~%# dim[1].label  = \"width\"~%# dim[1].size   = 640~%# dim[1].stride = 3*640 = 1920~%# dim[2].label  = \"channel\"~%# dim[2].size   = 3~%# dim[2].stride = 3~%#~%# multiarray(i,j,k) refers to the ith row, jth column, and kth channel.~%~%================================================================================~%MSG: std_msgs/MultiArrayDimension~%string label   # label of given dimension~%uint32 size    # size of given dimension (in type units)~%uint32 stride  # stride of given dimension~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'InverseKinematicsPath-response)))
  "Returns full string definition for message of type 'InverseKinematicsPath-response"
  (cl:format cl:nil "std_msgs/Float32MultiArray[] articular_path     ~%~%#Yes, the result is an array of arrays. Each Float32MultiArray is an array of seven floats~%#that represents the angles of each joint.~%#Articular_path is an array of n articular positions.~%#Float32MultiArray is used because left and right arm nodes are subscribed to topics of this type~%~%#Cartesian path is an array of Poses, and each pose represent a position in a 6DOF space,~%#neverthless, arm is 7DOF. The IK algorithm is supossed to calculate the best elbow position~%#for each Pose.~%~%#If goal pose is out of the workspace, a false should be returned when service is called.~%#Reachability of a given position can be determined by trying to calculate its inverse kinematics~%~%================================================================================~%MSG: std_msgs/Float32MultiArray~%# Please look at the MultiArrayLayout message definition for~%# documentation on all multiarrays.~%~%MultiArrayLayout  layout        # specification of data layout~%float32[]         data          # array of data~%~%~%================================================================================~%MSG: std_msgs/MultiArrayLayout~%# The multiarray declares a generic multi-dimensional array of a~%# particular data type.  Dimensions are ordered from outer most~%# to inner most.~%~%MultiArrayDimension[] dim # Array of dimension properties~%uint32 data_offset        # padding elements at front of data~%~%# Accessors should ALWAYS be written in terms of dimension stride~%# and specified outer-most dimension first.~%# ~%# multiarray(i,j,k) = data[data_offset + dim_stride[1]*i + dim_stride[2]*j + k]~%#~%# A standard, 3-channel 640x480 image with interleaved color channels~%# would be specified as:~%#~%# dim[0].label  = \"height\"~%# dim[0].size   = 480~%# dim[0].stride = 3*640*480 = 921600  (note dim[0] stride is just size of image)~%# dim[1].label  = \"width\"~%# dim[1].size   = 640~%# dim[1].stride = 3*640 = 1920~%# dim[2].label  = \"channel\"~%# dim[2].size   = 3~%# dim[2].stride = 3~%#~%# multiarray(i,j,k) refers to the ith row, jth column, and kth channel.~%~%================================================================================~%MSG: std_msgs/MultiArrayDimension~%string label   # label of given dimension~%uint32 size    # size of given dimension (in type units)~%uint32 stride  # stride of given dimension~%~%"))
