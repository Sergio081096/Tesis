...
(cl:ensure-generic-function 'ages-val :lambda-list '(m))
(cl:defmethod ages-val ((m <VisionFaceObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_msgs-msg:ages-val is deprecated.  Use vision_msgs-msg:ages instead.")
  (ages m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VisionFaceObject>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'ages)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VisionFaceObject>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'ages) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VisionFaceObject>)))
  ...
  "bab8b4bdfa73f5f1fd24e4e064a9d018")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VisionFaceObject)))
  "Returns md5sum for a message object of type 'VisionFaceObject"
  "bab8b4bdfa73f5f1fd24e4e064a9d018")
