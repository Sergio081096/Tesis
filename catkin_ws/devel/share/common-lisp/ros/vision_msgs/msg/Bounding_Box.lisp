...
(cl:defmethod cl:initialize-instance :after ((m <Bounding_Box>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bounding_Box)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vision_msgs-msg:<Bounding_Box> is deprecated: use vision_msgs-msg:Bounding_Box instead.")))
...
(cl:defmethod probability-val ((m <Bounding_Box>))
