...
(cl:ensure-generic-function 'inFront-val :lambda-list '(m))
(cl:defmethod inFront-val ((m <FindPlane-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision_msgs-srv:inFront-val is deprecated.  Use vision_msgs-srv:inFront instead.")
  (inFront m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FindPlane-request>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'inFront) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FindPlane-request>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'point_cloud) istream)
    (cl:setf (cl:slot-value msg 'inFront) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FindPlane-request>)))
  ...
  "ccc4f5bf8dc5cecf5cddd2fc69020571")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FindPlane-request)))
  "Returns md5sum for a message object of type 'FindPlane-request"
  "ccc4f5bf8dc5cecf5cddd2fc69020571")
