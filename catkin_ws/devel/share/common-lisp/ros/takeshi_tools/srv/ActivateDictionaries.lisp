...
(cl:in-package takeshi_tools-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ActivateDictionaries-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActivateDictionaries-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name takeshi_tools-srv:<ActivateDictionaries-request> is deprecated: use takeshi_tools-srv:ActivateDictionaries-request instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <ActivateDictionaries-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader takeshi_tools-srv:names-val is deprecated.  Use takeshi_tools-srv:names instead.")
  (names m))

(cl:ensure-generic-function 'active-val :lambda-list '(m))
(cl:defmethod active-val ((m <ActivateDictionaries-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader takeshi_tools-srv:active-val is deprecated.  Use takeshi_tools-srv:active instead.")
  (active m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActivateDictionaries-request>)))
  ...
  "takeshi_tools/ActivateDictionariesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActivateDictionaries-request)))
  "Returns string type for a service object of type 'ActivateDictionaries-request"
  "takeshi_tools/ActivateDictionariesRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActivateDictionaries-request>)))
  ...
  (cl:format cl:nil "# dictionary names~%string[] names~%~%# True: change to active, False: change to inactive~%bool active~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActivateDictionaries-request)))
  "Returns full string definition for message of type 'ActivateDictionaries-request"
  (cl:format cl:nil "# dictionary names~%string[] names~%~%# True: change to active, False: change to inactive~%bool active~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <ActivateDictionaries-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActivateDictionaries-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name takeshi_tools-srv:<ActivateDictionaries-response> is deprecated: use takeshi_tools-srv:ActivateDictionaries-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <ActivateDictionaries-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader takeshi_tools-srv:result-val is deprecated.  Use takeshi_tools-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <ActivateDictionaries-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader takeshi_tools-srv:message-val is deprecated.  Use takeshi_tools-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActivateDictionaries-response>)))
  ...
  "takeshi_tools/ActivateDictionariesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActivateDictionaries-response)))
  "Returns string type for a service object of type 'ActivateDictionaries-response"
  "takeshi_tools/ActivateDictionariesResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActivateDictionaries-response>)))
  ...
  (cl:format cl:nil "~%# True: success, False: failure~%bool result~%~%# error message~%string message~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActivateDictionaries-response)))
  "Returns full string definition for message of type 'ActivateDictionaries-response"
  (cl:format cl:nil "~%# True: success, False: failure~%bool result~%~%# error message~%string message~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActivateDictionaries)))
  ...
  "takeshi_tools/ActivateDictionaries")