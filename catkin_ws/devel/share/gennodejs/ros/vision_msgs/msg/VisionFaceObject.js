...
class VisionFaceObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ages')) {
        this.ages = initObj.ages
      }
      else {
        this.ages = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ages]
    bufferOffset = _serializer.int8(obj.ages, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ages]
    data.ages = _deserializer.int8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.ages !== undefined) {
      resolved.ages = msg.ages;
    }
    else {
      resolved.ages = 0
    }
