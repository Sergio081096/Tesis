...
class VisionObject {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Bounding_Box.serialize(obj.bounding_box, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.bounding_box = Bounding_Box.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += Bounding_Box.getMessageSize(object.bounding_box);
  ...
  static md5sum() {
    ...
    return 'f65ce1b1fe3980ac143db4ee4dbd70da';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.bounding_box !== undefined) {
      resolved.bounding_box = Bounding_Box.Resolve(msg.bounding_box)
    }
    else {
      resolved.bounding_box = new Bounding_Box()
    }
