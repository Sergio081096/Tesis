...
class FindPlaneRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('inFront')) {
        this.inFront = initObj.inFront
      }
      else {
        this.inFront = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [inFront]
    bufferOffset = _serializer.bool(obj.inFront, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [inFront]
    data.inFront = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'c1a80390cfed85ee23aa728be90888df';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.inFront !== undefined) {
      resolved.inFront = msg.inFront;
    }
    else {
      resolved.inFront = false
    }
...
module.exports = {
  ...
  md5sum() { return 'ccc4f5bf8dc5cecf5cddd2fc69020571'; },
