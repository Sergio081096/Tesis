...
let OpenPoseRecognition = require('../msg/OpenPoseRecognition.js');

//-----------------------------------------------------------

class OpenPoseRecognizeRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OpenPoseRecognizeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OpenPoseRecognizeRequest
    let len;
    let data = new OpenPoseRecognizeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OpenPoseRecognizeRequest(null);
...
class OpenPoseRecognizeResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OpenPoseRecognizeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OpenPoseRecognizeResponse
    let len;
    let data = new OpenPoseRecognizeResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OpenPoseRecognizeResponse(null);
...
module.exports = {
  Request: OpenPoseRecognizeRequest,
  Response: OpenPoseRecognizeResponse,
  md5sum() { return 'bc6fe00995db36c68d2577234a53f272'; },
  datatype() { return 'vision_msgs/OpenPoseRecognize'; }
};
