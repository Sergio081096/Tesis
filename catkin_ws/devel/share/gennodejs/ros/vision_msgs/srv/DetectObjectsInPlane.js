...
class DetectObjectsInPlaneRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('plane_height')) {
        ...
        this.plane_height = new std_msgs.msg.Float64();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DetectObjectsInPlaneRequest
    // Serialize message field [plane_height]
    bufferOffset = std_msgs.msg.Float64.serialize(obj.plane_height, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DetectObjectsInPlaneRequest
    let len;
    let data = new DetectObjectsInPlaneRequest(null);
    // Deserialize message field [plane_height]
    data.plane_height = std_msgs.msg.Float64.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectObjectsInPlaneRequest(null);
    if (msg.plane_height !== undefined) {
      resolved.plane_height = std_msgs.msg.Float64.Resolve(msg.plane_height)
    }
    else {
      resolved.plane_height = new std_msgs.msg.Float64()
    }
...
class DetectObjectsInPlaneResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DetectObjectsInPlaneResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DetectObjectsInPlaneResponse
    let len;
    let data = new DetectObjectsInPlaneResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'vision_msgs/DetectObjectsInPlaneResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectObjectsInPlaneResponse(null);
...
module.exports = {
  Request: DetectObjectsInPlaneRequest,
  Response: DetectObjectsInPlaneResponse,
  md5sum() { return 'b0ee0e52c6c079b90f5fcb34e11d697c'; },
  datatype() { return 'vision_msgs/DetectObjectsInPlane'; }
};
