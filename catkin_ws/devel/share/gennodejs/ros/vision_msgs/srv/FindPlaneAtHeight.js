...
class FindPlaneAtHeightRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('minH')) {
        ...
        this.minH = new std_msgs.msg.Float64();
      }
      if (initObj.hasOwnProperty('maxH')) {
        this.maxH = initObj.maxH
      }
      else {
        this.maxH = new std_msgs.msg.Float64();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FindPlaneAtHeightRequest
    ...
    bufferOffset = std_msgs.msg.Float64.serialize(obj.minH, buffer, bufferOffset);
    // Serialize message field [maxH]
    bufferOffset = std_msgs.msg.Float64.serialize(obj.maxH, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FindPlaneAtHeightRequest
    let len;
    let data = new FindPlaneAtHeightRequest(null);
    ...
    data.minH = std_msgs.msg.Float64.deserialize(buffer, bufferOffset);
    // Deserialize message field [maxH]
    data.maxH = std_msgs.msg.Float64.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindPlaneAtHeightRequest(null);
    ...
    if (msg.minH !== undefined) {
      resolved.minH = std_msgs.msg.Float64.Resolve(msg.minH)
    }
    else {
      resolved.minH = new std_msgs.msg.Float64()
    }

    if (msg.maxH !== undefined) {
      resolved.maxH = std_msgs.msg.Float64.Resolve(msg.maxH)
    }
    else {
      resolved.maxH = new std_msgs.msg.Float64()
    }
...
class FindPlaneAtHeightResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.header = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FindPlaneAtHeightResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FindPlaneAtHeightResponse
    let len;
    let data = new FindPlaneAtHeightResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'vision_msgs/FindPlaneAtHeightResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindPlaneAtHeightResponse(null);
...
module.exports = {
  Request: FindPlaneAtHeightRequest,
  Response: FindPlaneAtHeightResponse,
  md5sum() { return '84267465f577c94cfad97d842f95b0bc'; },
  datatype() { return 'vision_msgs/FindPlaneAtHeight'; }
};
