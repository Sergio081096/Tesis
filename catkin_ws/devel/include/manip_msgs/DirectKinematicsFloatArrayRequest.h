...
bool operator==(const ::manip_msgs::DirectKinematicsFloatArrayRequest_<ContainerAllocator1> & lhs, const ::manip_msgs::DirectKinematicsFloatArrayRequest_<ContainerAllocator2> & rhs)
{
