...
bool operator==(const ::navig_msgs::Location_<ContainerAllocator1> & lhs, const ::navig_msgs::Location_<ContainerAllocator2> & rhs)
{
  return lhs.id == rhs.id &&
    lhs.position == rhs.position &&
    lhs.orientation == rhs.orientation &&
    lhs.correct_angle == rhs.correct_angle;
}
