...
bool operator==(const ::vision_msgs::RecognizeObjectRequest_<ContainerAllocator1> & lhs, const ::vision_msgs::RecognizeObjectRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::vision_msgs::RecognizeObjectRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sensor_msgs/PointCloud2 point_cloud     #Point cloud where the object will be searched\n"
