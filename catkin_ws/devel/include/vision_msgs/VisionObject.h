...
#include <vision_msgs/Bounding_Box.h>
#include <geometry_msgs/Vector3.h>
...
struct VisionObject_
{
  ...
  _pose_type pose;
   ...
   typedef  ::vision_msgs::Bounding_Box_<ContainerAllocator>  _bounding_box_type;
...
struct MD5Sum< ::vision_msgs::VisionObject_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf65ce1b1fe3980acULL;
  static const uint64_t static_value2 = 0x143db4ee4dbd70daULL;
};
...
struct Printer< ::vision_msgs::VisionObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vision_msgs::VisionObject_<ContainerAllocator>& v)
  {
    ...
    s << std::endl;
    Printer< ::vision_msgs::Bounding_Box_<ContainerAllocator> >::stream(s, indent + "  ", v.bounding_box);
