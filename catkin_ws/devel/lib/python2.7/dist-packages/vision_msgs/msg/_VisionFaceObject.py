...
class VisionFaceObject(genpy.Message):
  _md5sum = "bab8b4bdfa73f5f1fd24e4e064a9d018"
...
float64 z
"""
  __slots__ = ['id','confidence','face_centroid','bounding_box','smile','gender','ages']
  _slot_types = ['string','float32','geometry_msgs/Point','geometry_msgs/Point[]','bool','int8','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,confidence,face_centroid,bounding_box,smile,gender,ages
