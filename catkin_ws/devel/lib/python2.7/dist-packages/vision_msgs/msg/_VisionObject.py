...
class VisionObject(genpy.Message):
  _md5sum = "f65ce1b1fe3980ac143db4ee4dbd70da"
...
int64 ymax"""
  ...
  _slot_types = ['std_msgs/Header','string','string','float32','sensor_msgs/Image','sensor_msgs/PointCloud2','geometry_msgs/Vector3','geometry_msgs/Pose','vision_msgs/Bounding_Box','geometry_msgs/Vector3[]','int32','int32','int32','int32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bounding_box is None:
        self.bounding_box = vision_msgs.msg.Bounding_Box()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d4q().pack(_x.bounding_box.probability, _x.bounding_box.xmin, _x.bounding_box.ymin, _x.bounding_box.xmax, _x.bounding_box.ymax))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.bounding_box.probability, _x.bounding_box.xmin, _x.bounding_box.ymin, _x.bounding_box.xmax, _x.bounding_box.ymax,) = _get_struct_d4q().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.bounding_polygon = []
