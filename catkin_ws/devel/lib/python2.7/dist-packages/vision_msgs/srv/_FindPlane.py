...
class FindPlaneRequest(genpy.Message):
  _md5sum = "c1a80390cfed85ee23aa728be90888df"
...
"""
  __slots__ = ['name','point_cloud','inFront']
  _slot_types = ['string','sensor_msgs/PointCloud2','bool']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.point_cloud.is_dense, _x.inFront))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.point_cloud.is_dense, _x.inFront,) = _get_struct_2B().unpack(str[start:end])
      self.point_cloud.is_dense = bool(self.point_cloud.is_dense)
      self.inFront = bool(self.inFront)
      return self
...
class FindPlane(object):
  ...
  _md5sum = 'ccc4f5bf8dc5cecf5cddd2fc69020571'
