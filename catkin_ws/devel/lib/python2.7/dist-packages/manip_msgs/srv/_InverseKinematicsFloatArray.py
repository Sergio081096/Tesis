...
uint32 stride  # stride of given dimension"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.cartesian_pose.layout.data_offset
...
class InverseKinematicsFloatArrayResponse(genpy.Message):
  _md5sum = "9f91baa25db30771c05689c75bfed68c"
...
float64 theta
"""
  __slots__ = ['articular_pose','torso_pose','base_correction']
  _slot_types = ['std_msgs/Float32MultiArray','std_msgs/Float32','geometry_msgs/Pose2D']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       articular_pose,torso_pose,base_correction
    ...
    if args or kwds:
      ...
      if self.torso_pose is None:
        self.torso_pose = std_msgs.msg.Float32()
      if self.base_correction is None:
        self.base_correction = geometry_msgs.msg.Pose2D()
    else:
      self.articular_pose = std_msgs.msg.Float32MultiArray()
      self.torso_pose = std_msgs.msg.Float32()
      self.base_correction = geometry_msgs.msg.Pose2D()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.articular_pose.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.articular_pose.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      ...
      _x = self
      buff.write(_get_struct_f3d().pack(_x.torso_pose.data, _x.base_correction.x, _x.base_correction.y, _x.base_correction.theta))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.torso_pose.data, _x.base_correction.x, _x.base_correction.y, _x.base_correction.theta,) = _get_struct_f3d().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class InverseKinematicsFloatArray(object):
  ...
  _md5sum = 'c4c1fd4b7cfed44c0704d5d3eb5d4b6e'
